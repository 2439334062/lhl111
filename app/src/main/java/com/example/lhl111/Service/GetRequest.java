package com.example.lhl111.Service;

import androidx.lifecycle.LiveData;

import com.example.lhl111.bean.NewsBean;
import com.example.lhl111.bean.PythonBean;
...
//    @GET("constellation_data.json")
//    LiveData<Resource<List<NewsBean>>> getConstellationList();
}
